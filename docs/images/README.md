# Current scene previews

These four images show the current scene. They are the images used in the
[project README](../../README.md).

| Weather | Preview |
| --- | --- |
| Rain — default scene | [rain.png](rain.png) |
| After rain | [after-rain.png](after-rain.png) |
| Clear | [clear.png](clear.png) |
