...
function createHorizonGrove(needle, needleDark) {
  ...
  const front = [
    [-13.85, -1.85, 0.22, 2.15],
    [-15.55, -2.35, 0.26, 2.75],
    [-17.35, -2.55, 0.24, 2.55],
    [-19.15, -3.05, 0.28, 2.95],
    [-14.65, -3.15, 0.2, 2.05],
    [-16.75, -3.55, 0.22, 2.45],
    [-18.55, -3.85, 0.24, 2.75],
    [-20.35, -3.45, 0.26, 2.55],
  ];
  const back = [
    [-14.35, -4.55, 0.24, 2.55],
    [-16.05, -5.05, 0.28, 3.05],
    [-17.85, -5.35, 0.26, 2.85],
    [-19.55, -5.75, 0.3, 3.15],
    [-15.45, -5.65, 0.22, 2.45],
    [-18.65, -6.25, 0.26, 2.85],
    [-16.95, -6.55, 0.24, 2.65],
  ];
  const outer = [
    [-23.6, -3.05, 0.26, 2.15],
    [-25.15, -3.85, 0.3, 2.55],
